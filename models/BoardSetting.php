...
use app\models\BoardSettingDefault;
 ...
 */
class BoardSetting extends ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            ['default_name', 'default', 'value' => function () {
                return BoardSettingsDefault::findOne(1)->default_name;
            }],
